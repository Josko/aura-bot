...
public:
  CGame(CAura *nAura, CMap *nMap, uint16_t nHostPort, unsigned char nGameState, std::string &nGameName, std::string &nOwnerName, std::string &nCreatorName, std::string &nCreatorServer);
  ~CGame();
  CGame(CGame &) = delete;
  ...
  void SendChat(unsigned char fromPID, CGamePlayer *player, const std::string &message);
  void SendChat(unsigned char fromPID, unsigned char toPID, const std::string &message);
  void SendChat(CGamePlayer *player, const std::string &message);
  void SendChat(unsigned char toPID, const std::string &message);
  void SendAllChat(unsigned char fromPID, const std::string &message);
  ...
  std::string GetDBPlayerNameFromColour(unsigned char colour) const;
