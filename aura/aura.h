...
public:
  ...
  void CreateGame(CMap *map, unsigned char gameState, std::string gameName, std::string ownerName, std::string creatorName, std::string creatorServer, bool whisper);
